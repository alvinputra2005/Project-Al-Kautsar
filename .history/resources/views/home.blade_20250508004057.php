...
<div id="beranda-section" class="position-relative overflow-hidden">
    <div class="carousel-background">
      <div id="carousel-beranda" class="carousel slide" data-ride="carousel" data-interval="1500">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="{{ asset('img/dpn/1.jpg') }}" class="d-block w-100" alt="Foto 11" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-video" id="profile">
  ...
  <section id="struktur">
    <h2>Struktur Kepengurusan Pondok</h2>
    <div class="wrapper">
      ...
      <div class="box struktur-box">
        Pendamping Kepala
        <div class="struktur-overlay">
          <img src="{{ asset('img/pendamping.png') }}" alt="Pendamping">
          <span>Bp. Ubayd</span>
          <img src="{{ asset('img/dg1.png') }}" alt="Dewan Guru">
          <span>Ust. Arif</span>
          <img src="{{ asset('img/dg5.png') }}" alt="Dewan Guru">
          <span>Ust. Tegar</span>
        </div>
      </div>
      <div class="line-vertical"></div>
      ...
      <div class="level">
        <div class="box struktur-box">
          Dewan Guru
          <div class="struktur-overlay">
            <img src="{{ asset('img/dg2.png') }}" alt="Dewan Guru">
            <span>Ust. Fandy</span>
            <img src="{{ asset('img/dg3.png') }}" alt="Dewan Guru">
            <span>Ust. Rio</span>
            <img src="{{ asset('img/dg4.png') }}" alt="Dewan Guru">
        ...
        <div class="box struktur-box">
          Pengurus Keuangan
          <div class="struktur-overlay">
            <img src="{{ asset('img/ku1.png') }}" alt="Keuangan">
            <span>Bp. Kholis</span>
            <img src="{{ asset('img/ku2.png') }}" alt="Keuangan">
            <span>Sdr. Roma</span>
            <img src="{{ asset('img/ku3.png') }}" alt="Keuangan">
      ...
      <div class="level">
        <div class="box struktur-box">
          Tim 7
          <div class="struktur-overlay">
            <img src="{{ asset('img/dg6.png') }}" alt="Tim 7">
            <span>Ust. Irvan</span>
            <img src="{{ asset('img/dg7.png') }}" alt="Tim 7">
            <span>Ust. Catur</span>
          </div>
        </div>
        <div class="box struktur-box">
          Penerobos
          <div class="struktur-overlay">
            <img src="{{ asset('img/pb1.png') }}" alt="Penerobos">
            <span>Sdr. Raihan</span>
            <img src="{{ asset('img/pb2.png') }}" alt="Penerobos">
            <span>Sdr. Sulthon</span>
            <img src="{{ asset('img/pb3.png') }}" alt="Penerobos">
            <span>Sdr. Wira</span>
            <img src="{{ asset('img/pb4.png') }}" alt="Penerobos">
            <span>Sdr. Ryant</span>
          </div>
        </div>
        <div class="box struktur-box">
          Kesiswaan
          <div class="struktur-overlay">
            <img src="{{ asset('img/ksw1.png') }}" alt="Kesiswaan">
            <span>Sdr. Arbi</span>
            <img src="{{ asset('img/ksw2.png') }}" alt="Kesiswaan">
            <span>Sdr. Panca</span>
          </div>
        </div>
      </div>
      ...
      <div class="box struktur-box">
        Santri
        <div class="struktur-overlay">
          <img src="{{ asset('img/sw1.png') }}" alt="Santri">
          <span>Santri Teladan</span>
          <img src="{{ asset('img/sw2.png') }}" alt="Santri">
        </div>
      </div>
  ...
  <section id="testimoni" style="scroll-margin-top: 200px;">
  ...
  <section id="statistik" style="scroll-margin-top: 10px;">
    ...
    <div class="stat-container">
      <div class="stat-box">
        ...
        <a href="tendik/tendik.php" class="btn-stat-left">Lihat Profil</a>
      </div>
      <div class="stat-box">
      ...
      <div class="stat-box">
        ...
        <p>Alumni</p><br>
        <a href="{{ route('alumni.index') }}" class="btn-stat">Info Alumni</a>
      </div>
      <div class="stat-box">
  ...
  <section id="kegiatan" >
    ...
    <div class="kegiatan-utama">
      ...
      <div class="overlay-text">
        ...
        <a href="{{ route('kegiatan') }}" class="btn-kegiatan"><i class="fas fa-users"></i>
lainnya
</a>
      </div>
    </div>
  ...
  <section  class="container my-5" id="prestasi" style="scroll-margin-top: 1px;">
    <div class="d-flex justify-content-between align-items-center mb-4" >
      <h2>Prestasi</h2>
      <a href="{{ route('') }}" class="btn btn-outline-primary"><i class="fas fa-medal"></i>Prestasi Selengkapnya</a>
    </div>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text">
            <b>Hasan Argadinata, S.Pd, M.Pd, MCE, CRA, CRMPA.</b><br>
            (S2 Maxima Cumlaude di Umur 23 Tahun)<br> 
            "Berprestasi tak mengenal batas usia! Di usia 23 tahun, perjalanan akademikku membawaku ke tingkat selanjutnya. Dari pondok pesantren hingga kuliah S2, setiap langkahku ditenun oleh semangat fisabilillah dan ketekunan. Terimakasih kepada semua yang telah mendukungku!." <br> 
            - Hasan Argadinata
          </p>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text">
            <b>Ayu Auliya Rahman S.Pd</b><br>
            (Lulusan UM S1 Pendidikan Biologi)<br>
            "Jarak jauh dari rumah merupakan bukan penghambat bagi kita untuk menimba ilmu, saya ,membuktikan bahwa semangat kuliah juga tidak akan terhambat dengan kegiatan dalam aktivitas di pondok. Orang tua mu akan bangga dengan kedua pencapaianmu." <br>
            - Ayu Aulya Rahman
          </p>
        </div>
      </div>
