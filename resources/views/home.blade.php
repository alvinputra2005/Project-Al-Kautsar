...
<div id="beranda-section" class="position-relative overflow-hidden">
  ...
  <section id="testimoni" style="scroll-margin-top: 200px;">
    ...
    <div class="text-center mt-4" >
      <a href="testimoni.php" class="btn-keren">Tambahkan Ulasanmu</a>
    </div>
  </section>
  ...
  <section id="statistik" >
    ...
    <div class="stat-container">
      <div class="stat-box">
        ...
        <a href="tendik.php" class="btn-stat">Lihat Profil</a>
      </div>
      <div class="stat-box">
        <div class="icon"><i class="fas fa-user-graduate"></i></div>
        <h3 class="counter" data-target="500">65</h3>
        <p>Mahasiswa Santri</p><br>
        <a href="santri.php" class="btn-stat">Data Santri</a>
      </div>
      <div class="stat-box">
      ...
      <a href="fasilitas.php" class="btn-stat">Lihat Fasilitas</a>
    </div>
    </div>
  </section>
  ...
  <section id="kegiatan" >
    ...
    <div class="kegiatan-utama">
      ...
      <div class="overlay-text">
        ...
        <a href="kegiatan.php" class="btn-kegiatan">Lihat Detail</a>
      </div>
    </div>
  ...
  <section  class="container my-5" id="prestasi">
    <div class="d-flex justify-content-between align-items-center mb-4" >
      <h2>Prestasi</h2>
      <a href="prestasi.php" class="btn btn-outline-primary">Lihat Selengkapnya</a>
    </div>
